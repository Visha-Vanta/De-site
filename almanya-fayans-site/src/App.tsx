...
const translations = {
  de: {
    ...
    hero: {
      ...
      stats: { exp: "Jahre Erfahrung", proj: "Abgeschlossene Projekte", sat: "Kundenzufriedenheit" },
      tagline: "Meisterbetrieb, Premium Qualität, Innovative Lösungen"
    },
    portfolio: {
      title: "Portfolio Galerie",
      desc: "Hochwertige Fliesen aus Keramik, Porzellan und Naturstein in maßgerechter Ausführung.",
    ...
    services: {
      ...
      cards: [
        ...
        { title: "Terrassen & Balkone", desc: "Professionelle Ausführung von Terrassen- und Balkondielen." },
  ...
  en: {
    ...
    hero: {
      ...
      stats: { exp: "Years Experience", proj: "Completed Projects", sat: "Client Satisfaction" },
      tagline: "Master Craftsmen, Premium Quality, Innovative Solutions"
    },
    portfolio: {
      title: "Portfolio Gallery",
      desc: "High-quality ceramic, porcelain, and natural stone tiles customized to your needs.",
    ...
    services: {
      ...
      cards: [
        { title: "Large Format Tiles", desc: "Precision cutting and installation for large-format tiles." },
        { title: "Natural Stone & Marble", desc: "Premium natural stone and marble installation." },
        { title: "Terraces & Balconies", desc: "Professional terrace and balcony installations." },
        { title: "Waterproofing Systems", desc: "Waterproofing solutions ensuring durability." }
      ]
    },
    quote: {
      text: "Quality is not a coincidence, but the result of proven techniques and passion.",
  ...
  tr: {
    ...
    services: {
      ...
      cards: [
        { title: "Büyük Ebatlı Fayans", desc: "Kusursuz görünüm için büyük ebatlı fayansların hassas kesimi." },
        { title: "Doğal Taş & Mermer", desc: "Usta işçilikle birinci sınıf doğal taş ve mermer uygulamaları." },
        { title: "Teras & Balkon", desc: "Teras ve balkon döşemeleriyle yaşam kalitesini artıran uygulamalar." },
        { title: "Su Yalıtım Sistemleri", desc: "Islak zeminlerde uzun ömürlü yalıtım çözümleri." }
      ]
    },
    quote: {
    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-stone-900/40 to-zinc-900 text-gray-200">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                {errors.name && <p className="text-red-400 text-sm mt-1 font-sans">{errors.name}</p>}
              </div>
              ...
              <div>
                ...
                {errors.email && <p className="text-red-400 text-sm mt-1 font-sans">{errors.email}</p>}
              </div>
              ...
              <div>
                ...
                {errors.phone && <p className="text-red-400 text-sm mt-1 font-sans">{errors.phone}</p>}
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 disabled:from-stone-600 disabled:to-stone-700 text-stone-950 font-serif font-bold py-4 rounded-xl transition-all duration-300 shadow-lg shadow-amber-500/20"
              >
                <Send className="w-5 h-5" />
                {isSubmitted ? 'Gesendet!' : t.contact.form.btn}
              </button>

              {isSubmitted && (
                <div className="p-4 bg-green-500/20 border border-green-500/30 rounded-xl text-green-300 font-sans text-center">
                  Ihre Nachricht wurde an WhatsApp gesendet!
                </div>
              )}
            </form>
          </div>
      ...
      <footer className="py-12 px-4 border-t border-stone-700/30">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-stone-400 font-sans mb-2">{t.footer}</p>
          <p className="text-stone-500 font-sans text-sm mb-4">Inhaber: Ergin Dedeoğlu</p>
          <div className="flex justify-center gap-6 text-stone-400 font-sans text-sm">
            <a href="/impressum" className="hover:text-amber-300 transition-colors">Impressum</a>
            <span className="text-stone-600">|</span>
            <a href="/datenschutz" className="hover:text-amber-300 transition-colors">Datenschutz</a>
          </div>
        </div>
      </footer>
    </div>
